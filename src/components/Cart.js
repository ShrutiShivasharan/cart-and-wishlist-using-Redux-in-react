...
import {removeFromCart,clearCart,incrementQuantity,decrementQuantity,applyCoupon,removeCoupon} from '../actions/CartAction'
...
function Cart() {
    ...
    const calculate_gst = (calculate_subtotal) => {
        return calculate_subtotal * 0.18;
    }
    const shipping = 100;
    const calculat_total = () => {
                            ...
                            <div className='container'>
                                <div className='flex justify-between'>
                                    ...
                                    <div className='coupon-div flex justify-end'>
                                        <input value={couponInput} onChange={(e)=> setCouponInput(e.target.value)} type='text' className='p-2' placeholder='Enter Coupon Code' />
                                        <button onClick={handleApplyCoupon} className=" text-white bg-blue-500 p-2 rounded mx-1 ">Apply</button>
                                        <button onClick={handleRemoveCoupon} className=" text-white bg-red-500 p-2 rounded mx-1 ">Remove</button>
                                    </div>
                                </div>
                                ...
                                <div className='flex p-5'>
                                    ...
                                    <strong><h1 className='ml-4 text-xl'><i class="fa-solid fa-rupee-sign"></i>. {calculat_total()} </h1></strong>
                                </div>
                            </div>
                            <div className='my-2'>
